...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pytest-memray-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pytest-memray-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pytest-memray
# for installing globally
pixi global install pytest-memray
```
...
It is possible to list all of the versions of `pytest-memray` available on your platform:
...
```
pixi search pytest-memray --channel conda-forge
```
